...
\hypersetup
{
    pdfauthor={Rob Jansen, Miles Richardson, Mainak Ghosh, Bryan Ford},
...
% \date{}
\title{On the Current Feasibility, Incentives, and Social Implications of Tor Monetization}

\author{Rob Jansen\inst{1} \and Miles Richardson\inst{2} \and Mainak Ghosh\inst{2} \and Bryan Ford\inst{2}}
...
\institute{
	...
	\email{\{miles.richardson, mainak.ghosh, bryan.ford\}@yale.edu}
}
...
%\input{sections/proof-of-bandwidth}
