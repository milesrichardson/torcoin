...
johnson2013onions}. We present a possible solution, embodying two complementary
novel ideas:
...
BitCoin, its proof-of-work  scheme is bandwidth-intensive, rather than
computationally-intensive. To ``mine''  a TorCoin, a relay transfers bandwidth
...
\\
\item
\textbf{TorPath} is a method for decentralized groups of ``Assignment Servers,''
