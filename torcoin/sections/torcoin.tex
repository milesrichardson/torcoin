...
% Because of the signatures $S^B_*$, the temporary
% keys $R_*$ function as 'commits'. No one relay can unilaterally recompute its
% temporary key without disrupting the blob $B$.
